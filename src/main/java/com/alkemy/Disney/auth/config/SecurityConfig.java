...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf()
                ...
                .antMatchers(HttpMethod.GET,"/api/v1/images/image/{id}").permitAll()
                .antMatchers(HttpMethod.GET,"/api/v1/gender/").permitAll()
                .antMatchers(HttpMethod.PUT,"/api/v1/gender/{id}").permitAll()
                .antMatchers(HttpMethod.DELETE,"/api/v1/gender/{id}").permitAll()
                .antMatchers(HttpMethod.GET,"/api/v1/gender/{id}").permitAll()
